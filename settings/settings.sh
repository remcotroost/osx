...
export SYSTEM_LABEL=Remco # Placeholder for system display name.
export SYSTEM_NAME=remco # Placeholder for system name.
...
export CSSCOMB_EXTENSION_URL="git://github.com/csscomb/sublime-csscomb.git"
